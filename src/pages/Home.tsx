        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="w-10 h-10 bg-yellow-600 rounded-full flex items-center justify-center">
              <span className="text-black font-bold">{user?.name?.charAt(0) || 'U'}</span>
            </div>
            <Button
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3">
              ...
              <div className="mb-12">
                ...
                <p className="text-xl text-gray-300 mb-8">
                  Learn with AI tutors and<br />master your subjects.
                </p>
              </div>

              {/* Popular Subjects */}
              <div>
                <h2 className="text-3xl font-bold text-white mb-8">Popular Subjects</h2>
                  ...
                  {subjects.map((subject, index) => (
                    <div key={index} className="bg-gray-900/80 backdrop-blur-sm border border-gray-700 rounded-xl p-6 hover:border-yellow-600/50 transition-all duration-300 cursor-pointer group">
                      <div className="flex flex-col items-center text-center">
                        <div className="w-20 h-20 rounded-full mb-4 overflow-hidden border-2 border-yellow-600/30 group-hover:border-yellow-600 transition-colors">
                          <img 
                            src={subject.image} 
                            alt={subject.title}
            ...
            <div className="lg:col-span-1 space-y-8">
              ...
              <div className="bg-gray-900/80 backdrop-blur-sm border border-gray-700 rounded-xl p-6">
                <h3 className="text-2xl font-bold text-white mb-6">Your Clan</h3>
                <div className="grid grid-cols-2 gap-4">
                  {clans.map((clan, index) => (
                    <div key={index} className={`${clan.color} rounded-lg p-4 text-center cursor-pointer hover:scale-105 transition-transform`}>
                      <div className="text-2xl mb-2">{clan.icon}</div>
                      <div className="text-white text-sm font-semibold">{clan.name}</div>
                    </div>
                  ))}
                </div>
              </div>
              ...
              {/* Challenge a Friend */}
              <div className="bg-gray-900/80 backdrop-blur-sm border border-gray-700 rounded-xl p-6">
                <h3 className="text-2xl font-bold text-white mb-6">Challenge a Friend</h3>
                <Button className="w-full bg-yellow-600 text-black hover:bg-yellow-700 transition-all duration-300 font-semibold">
                  Start Challenge
                </Button>
                
                <div className="mt-6 text-center">
                  <div className="w-16 h-16 mx-auto rounded-full overflow-hidden border-2 border-yellow-600/30">
                    <img 
